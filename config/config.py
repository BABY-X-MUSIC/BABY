...
EXTRA_PLUGINS_REPO = getenv(
    "EXTRA_PLUGINS_REPO",
    "https://github.com/BABY-X-MUSIC/Extra-Plugin", 
)
...
# Your User ID.
OWNER_ID = list(
    map(int, getenv("OWNER_ID", "7380417336").split())
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/BABY-X-MUSIC/BABY",
)
...
SUPPORT_CHANNEL = getenv(
    "SUPPORT_CHANNEL", "https://t.me/UFC_NETWORK"
)  # Example:- https://t.me/VIP_CREATORS
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP", "https://t.me/UFC_LINK_ZONE"
...
GITHUB_REPO = getenv("GITHUB_REPO", "https://t.me/UFC_LINK_ZONE")
...
START_IMG_URL = getenv(
    "START_IMG_URL",
    "https://files.catbox.moe/r6cw0b.jpg",
)
...
if PING_IMG_URL:
    if PING_IMG_URL != "https://files.catbox.moe/hbkwsg.jpg":
...
if PLAYLIST_IMG_URL:
    if PLAYLIST_IMG_URL != "hhttps://files.catbox.moe/r6cw0b.jpg":
...
if GLOBAL_IMG_URL:
    if GLOBAL_IMG_URL != "https://files.catbox.moe/r6cw0b.jpg":
...
if STATS_IMG_URL:
    if STATS_IMG_URL != "https://files.catbox.moe/r6cw0b.jpg":
...
if TELEGRAM_AUDIO_URL:
    if TELEGRAM_AUDIO_URL != "https://files.catbox.moe/r6cw0b.jpg":
...
if STREAM_IMG_URL:
    if STREAM_IMG_URL != "https://files.catbox.moe/r6cw0b.jpg":
...
if SOUNCLOUD_IMG_URL:
    if SOUNCLOUD_IMG_URL != "https://files.catbox.moe/r6cw0b.jpg":
...
if YOUTUBE_IMG_URL:
    if YOUTUBE_IMG_URL != "https://files.catbox.moe/r6cw0b.jpg":
...
if TELEGRAM_VIDEO_URL:
    if TELEGRAM_VIDEO_URL != "https://files.catbox.moe/r6cw0b.jpg":
